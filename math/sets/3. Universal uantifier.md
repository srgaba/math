...
- Example, given this statement ∀x ∈ R, x^2 ≥ 0, the statement is true because every real number squared is greater than or equal to zero.
- Example, given this statement ∀x ∈ A, x ≠ 0, where A is non empty set, the statement sais that every element in the set is not equal to zero.
